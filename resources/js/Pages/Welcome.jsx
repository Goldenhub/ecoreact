...
export default function Welcome({ categories, tools, date }) {
            ...
            <div className="bg-[#EEF5FF]">
                <div className="relative min-h-screen flex flex-col justify-start selection:bg-[#176B87] selection:text-[#EEF5FF]">
                    <div className="relative">
                        <Header />
                        <main className="mt-6">
                            <section className='text-center mb-10 px-'>
                                <h1 className='text-4xl font-extrabold mb-4 text-[#176B87]'>Welcome to the React Ecosystem</h1>
